...
class Sim:
	def __init__(self, num_iters, base_num_users, base_rate, etime, streaming, backend, model, manage):
		self.users = []
		...
		self.client = Client(streaming=streaming, backend=backend, model=model, manage=manage)
		self.req_num = 0
